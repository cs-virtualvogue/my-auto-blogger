...
def generate_article_with_retry():
    ...
    1. **ภารกิจของคุณ**: เขียนบทความเจาะลึกน้ำหอม Niche บทความเกี่ยวกับ Baccarat Rouge 540 (BR 540) และ Escentric Molecules Molecule 01 ชื่อบทความ Decoding The Invisible Scent: เจาะลึกเคมีลับเบื้องหลัง Baccarat Rouge 540 และ Molecule 01 น้ำหอมที่คนฉีดไม่ได้กลิ่น แต่คนรอบข้างเหลียวหลัง ความยาวประมาณ 2000 คำ**
   ...
   - ปิดท้ายบทความด้วยการใส่โค้ด HTML อ้างอิงแหล่งข้อมูลที่น่าเชื่อถือด้านล่างนี้ (ถ้ามีลิงค์สามารถใส่และแนบลิงค์เข้ามาด้วยได้):
